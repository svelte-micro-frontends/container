...
var app = (function (exports) {
	...
	function create_default_slot_4(ctx) {
		...
		dispatch_dev("SvelteRegisterBlock", {
			...
			type: "slot",
			source: "(18:10) <Link to=\\\"/restaurants\\\">",
			ctx
		});
	...
	function create_default_slot(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(h1, file$2, 12, 6, 315);
				attr_dev(div0, "class", "center-column svelte-1molj3y");
				add_location(div0, file$2, 11, 4, 281);
				attr_dev(li0, "class", "svelte-1molj3y");
				add_location(li0, file$2, 16, 8, 397);
				attr_dev(li1, "class", "svelte-1molj3y");
				add_location(li1, file$2, 19, 8, 484);
				attr_dev(li2, "class", "svelte-1molj3y");
				add_location(li2, file$2, 22, 8, 559);
				attr_dev(ol, "class", "center-column svelte-1molj3y");
				add_location(ol, file$2, 15, 6, 362);
				attr_dev(nav, "class", "svelte-1molj3y");
				add_location(nav, file$2, 14, 4, 350);
				attr_dev(header, "class", "svelte-1molj3y");
				add_location(header, file$2, 10, 2, 268);
				add_location(div1, file$2, 27, 2, 642);
			},
			m: function mount(target, anchor) {
